package com.hib.jsf;
// Strp 2 - write directly DAOImpl here
//critiaa can guve restrictions 
...
public class EmployDAOImpl {
	...
	public List<String> getNames(){
		sf = SessionHelper.getConncetion();
	...
	public List<String> getDepartments(){
		SessionFactory sf = SessionHelper.getConncetion();
	...
	public void employLocaleCodeChanged(ValueChangeEvent e) {
		//assign new value to lacalecode
	...
	FacesContext.getCurrentInstance().getExternalContext().getSessionMap();
		...
		if(count==1) {
			return "ShowDeptNew.xhtml?faces-redirect=true";
		}else {
